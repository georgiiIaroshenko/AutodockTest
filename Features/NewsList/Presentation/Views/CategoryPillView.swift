...
final class CategoryPillView: UIView, ContentResettable {
    ...
    private let label = LabelFactory().make(.init( font: .preferredFont(forTextStyle: .caption1), textColor: .black, numberOfLines: 1, cornerRadius: 8, masksToBounds: true, backgroundColor: .darkGray, textInsets: .init(top: 4, left: 8, bottom: 4, right: 8)))
